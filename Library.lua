...
local Library = {
    ...
    -- colors and font --
-- ⭐ LUNAR STYLE DEFAULTS ⭐
FontColor = Color3.fromHex("FFFFFF");
MainColor = Color3.fromHex("1A1B20");
BackgroundColor = Color3.fromHex("14151A");

AccentColor = Color3.fromHex("6B5CFF"); -- Lunar purple-blue glow
DisabledAccentColor = Color3.fromHex("4A4A5F");

OutlineColor = Color3.fromHex("2A2B33");
DisabledOutlineColor = Color3.fromHex("3A3B45");

DisabledTextColor = Color3.fromHex("8A8AA0");
...
do
   ...
   local function CreateBaseButton(Button)
    ...
    -- Remove the old bright gradient (not Lunar style)
    -- Add a subtle Lunar gloss instead
    Library:Create("UIGradient", {
        Color = ColorSequence.new({
...
function Library:Roundify(Inst, Radius)
    local Corner = Instance.new("UICorner")
    Corner.CornerRadius = UDim.new(0, Radius or 6)
    Corner.Parent = Inst
end

function Library:AddShadow(Inst)
...
----
getgenv().Lunar = Library
if getgenv().skip_getgenv_Lunar ~= true then getgenv().Library = Library end
return Library
